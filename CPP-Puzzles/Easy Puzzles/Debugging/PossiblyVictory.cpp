...
int main() {
    int runOfFirstTime,totalOver,runOfSecondTime;
    cin>>runOfFirstTime>>totalOver>>runOfSecondTime;
    
    int maximumRunCanMade = ((20 - totalOver) * 6) * 6;
    if(abs(runOfSecondTime - runOfFirstTime) < maximumRunCanMade) cout<<"YES"<<endl;
    else cout<<"NO"<<endl;
}
